          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Add New Branch</p>

                <form class="mx-1 mx-md-4" action = "addBranch" method = "POST">

                  <div class="d-flex flex-row align-items-center mb-4">
                    <i class="fas fa-cab fa-lg me-3 fa-fw"></i>
                    <div class="form-outline flex-fill mb-0">
                      <input type="text" id="form3Example1c" class="form-control" name = "name"/>
                      <label class="form-label" for="form3Example1c">Branch Name</label>
                    </div>
                  </div>
        			...
        			try{
						...
						while(rs.next())
						{
							...
							<tr>
						  	  ...
						  	  <th><form action="deleteBranch" method = "POST">
