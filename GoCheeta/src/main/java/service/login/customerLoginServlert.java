...
/**
 * Servlet implementation class customerLoginServlert
 */
@WebServlet("/customerLoginServlert")
public class customerLoginServlert extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean isTrue = CustomerDBUtil.validate(email,password);
